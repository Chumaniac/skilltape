...
const TARGET_ID: &str = "codex";

#[derive(Clone, Copy, Debug, Default)]
pub struct CodexExporter;

impl Exporter for CodexExporter {
    ...
    fn export(
        ...
        let prefix = format!(".agents/skills/{}/", package.manifest.name);
        Ok(ExportManifest {
