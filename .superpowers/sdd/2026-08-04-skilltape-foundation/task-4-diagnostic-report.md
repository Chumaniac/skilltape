...
Fix round 2 (2026-08-05): Added the missing `("skilltape.lock", "scripts[0].path")` expectation to explicitly assert PKG008 for lockfile script interpolation. Commit: `4dcd530` (`test: cover lockfile input references`).
